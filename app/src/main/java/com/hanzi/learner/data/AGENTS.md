...
Persistence and data contracts: Room schema/DAO, repository contracts and implementations, backup serialization utilities, TTS preferences.
## WHERE TO LOOK
| Task | Location | Notes |
|---|---|---|
...
| TTS preferences | `repository/TtsPreferenceRepository.kt`, `local/dao/TtsPreferenceDao.kt` | model selection, speech rate, pitch |
## CONVENTIONS
...
- TTS settings use `TtsSettings` model with validated ranges.
## ANTI-PATTERNS
