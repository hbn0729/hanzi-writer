...
object TtsModelRegistry {
    ...
    private val models: List<TtsModelInfo> = listOf(
        TtsModelInfo(
            ...
            downloadUrl = null,
            previewAudioUrl = "https://example.com/previews/system-tts.mp3",
            fileSizeBytes = 0,
        ...
        TtsModelInfo(
            ...
            downloadUrl = "https://example.com/models/vits-zh-hf-fanchen-wnj/",
            previewAudioUrl = "https://example.com/previews/vits-zh-hf-fanchen-wnj.mp3",
        ...
        TtsModelInfo(
            ...
            downloadUrl = "https://example.com/models/vits-zh-hf-theresa/",
            previewAudioUrl = "https://example.com/previews/vits-zh-hf-theresa.mp3",
